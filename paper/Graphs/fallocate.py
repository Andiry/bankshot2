...
color_pattern = ['1','0.5', '0.7', '0.3','0.6','0.9', '0.2', '0.5', '0.8', '0.1', '0.4','0.7', '1'] #light and contrasting colors
hatch_pattern = ['\\','/','.','*','+','/', ' ', 'x', ' ', '-'] 
for j in range(2):
    name = 'rects' + str(j)
...
ax.legend((rects[0][0], rects[1][0]), types, loc = "upper left", prop = {'size': 40}, ncol = 2)
plt.show()
