...
ax.text(.5, .9, '1 thread', horizontalalignment = 'center', transform=ax.transAxes, fontsize = '20')
...
ax1.text(.5, .9, '4 threads', horizontalalignment = 'center', transform=ax1.transAxes, fontsize = '20')
...
ax2.text(.5, .9, '16 threads', horizontalalignment = 'center', transform=ax2.transAxes, fontsize = '20')
