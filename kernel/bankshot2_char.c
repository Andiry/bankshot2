...
{
	struct bankshot2_device *bs2_dev = container_of(inode->i_cdev, struct bankshot2_device,
						chardev);
...
long bankshot2_char_ioctl(struct file *filp, unsigned int cmd, unsigned long arg)
{
